...
export default function Home() {
  ...
  return (
    <div>
      <header className="flex flex-wrap sm:justify-start sm:flex-nowrap z-50 w-full bg-white border-b border-gray-200 text-sm py-3 dark:bg-neutral-800 dark:border-neutral-700 h-[5rem]">
        <nav className="relative max-w-[85rem] w-full mx-auto px-4 sm:flex sm:items-center sm:justify-between sm:px-6 lg:px-8">
          ...
          >
            <div className="flex flex-col sm:flex-row sm:items-center sm:justify-end sm:ps-7">
              {!user?.user?.email ? (
                <Authentication>
                  <button className="flex items-center gap-x-2 font-medium px-4 py-2 sm:py-2.5 transition-all duration-300 bg-gradient-to-br from-blue-600 to-violet-600 hover:to-blue-700 text-white rounded-full shadow-lg hover:shadow-xl sm:border-s sm:border-gray-200 sm:ms-4 sm:my-6 sm:ps-6 dark:border-neutral-700 dark:hover:shadow-neutral-700/40">
                    <svg
